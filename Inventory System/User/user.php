  ...
  <body>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label for="userContanct" class="form-label">Contact Number</label>
              <input type="text" class="form-control" id="userContact" placeholder="Enter the contact number">
            </div>
            <div class="mb-3">
              <label for="userEmail" class="form-label">Email</label>
              <input type="text" class="form-control" id="userEmail" placeholder="Enter the email">
            </div>
            <div class="mb-3">
              <label for="userUsername" class="form-label">Username</label>
              <input type="text" class="form-control" id="userUsername" placeholder="Enter the username">
            </div>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label for="editContanct" class="form-label">Contact Number</label>
              <input type="text" class="form-control" id="editContact" placeholder="Enter the contact number">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="editUsername" placeholder="Enter the username">
            </div>
          </div>
          <div class="modal-footer">
    ...
    <div class="table-wrapper" >
        <div class="container my-3">
          <h2 class="text-center" style="margin-left: 185px;">Users</h2>
    ...
    <script>
      // create
      function adduser(){
        var nameAdd=$('#userName').val();
        var contactAdd=$('#userContact').val();
        var emailAdd=$('#userEmail').val();
        var usernameAdd=$('#userUsername').val();
      ...
      $('.update_button').on('click', function() {
        ...
        $('#editName').val(data[1]);
        $('#editContact').val(data[2]);
        $('#editEmail').val(data[3]);
        $('#editUsername').val(data[4]);

        // confirm update button
        $('#update_data_btn').off().on('click', function(e) {
          e.preventDefault();

          var id = data[0]; // Get the user ID from the data array
