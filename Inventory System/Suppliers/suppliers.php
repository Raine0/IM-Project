  ...
  <body>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Add a Supplier</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="mb-3">
              <label for="supplierOf" class="form-label">Supplier of</label>
              <input type="text" class="form-control" id="supplierOf" placeholder="Enter the product being supplied">
            </div>
            <div class="mb-3">
              <label for="supplierName" class="form-label">Name</label>
              <input type="text" class="form-control" id="supplierName" placeholder="Enter the name">
            </div>
            <div class="mb-3">
              <label for="supplierAddress" class="form-label">Address</label>
              <input type="text" class="form-control" id="supplierAddress" placeholder="Enter the address">
            </div>
            <div class="mb-3">
              <label for="supplierNumber" class="form-label">Phone Number</label>
              <input type="text" class="form-control" id="supplierNumber" placeholder="Enter the phone number">
            </div>
            <div class="mb-3">
              <label for="supplierEmail" class="form-label">Email</label>
              <input type="text" class="form-control" id="supplierEmail" placeholder="Enter the email">
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-dark" onclick="addsupplier()">Submit</button>
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Update a Supplier</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="mb-3">
              <label for="editSupplier" class="form-label">Supplier of</label>
              <input type="text" class="form-control" id="editSupplier" placeholder="Enter the product being supplied">
            </div>
            <div class="mb-3">
    ...
    <div class="table-wrapper">
        <div class="container my-3">
          <h2 class="text-center" style="margin-left: 185px;">Suppliers</h2>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $row["supplier_of"] ?></td>
    ...
    <script>
      ...
      function addsupplier(){
        var supplierAdd=$('#supplierOf').val();
        var nameAdd=$('#supplierName').val();
        var addressAdd=$('#supplierAddress').val();
        var numberAdd=$('#supplierNumber').val();
        var emailAdd=$('#supplierEmail').val();
      ...
      $('.delete_button').click(function (e) {
        ...
        var id = $(this).closest('tr').find('.supplier_id').text();
        console.log(id);
        $('#supplier_id').val(id);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response === 'successful') {
                        ...
                        $('td.supplier_id').filter(function () {
                            return $(this).text() === id;
                        }).closest('tr').remove();
                    }
                }
      ...
      $('.update_button').on('click', function() {
        ...
        $('#editSupplier').val(data[1]);
        $('#editName').val(data[2]);
        $('#editAddress').val(data[3]);
        $('#editNumber').val(data[4]);
